...
const jobCards = [
  ...
  new JobCardData(
    ...
    'Awesome Books is a simple website that stores a booklists, allowing you to revisit it later and add or remove any books you would like to read. The inner workings of this project rely on JavaScript to dynamically generate the list of books based on user input and also make use of localStorage.',
    './img/projects/awesome-books.png',
    './img/projects/awesome-books.png',
    'Self-employed',
    'Front-End',
  ...
  new JobCardData(
    'JS Documentation',
    'JS documentation is a simple documentation page to serve as instruction or reference. It was builded with plain HTML and CSS',
    './img/projects/documentation-page.png',
    ['HTML', 'CSS'],
    ...
    'JS documentation is a simple documentation page to serve as instruction or reference. It was builded with plain HTML and CSS to put in practice HTML and CSS basic skills. the content has been taken from MDN',
    './img/projects/documentation-page.png',
    './img/projects/documentation-page.png',
    'Self-employed',
    'Front-End',
  ...
  new JobCardData(
    ...
    'Product Landing Page is a project to market a product, in this case Original Trombones, it was builded for putting in practice HTML and CSS skills by creating an static site that include navigation, video, and a simple dummy form for submitting customer email.',
    './img/projects/landing-page-original-trombones.png',
    ['HTML', 'CSS'],
    'https://diegogagan2587.github.io/product-landing-page/',
    'https://github.com/Diegogagan2587/product-landing-page',
    'Product Landing Page is a project to market a product, in this case Original Trombones, it was builded for putting in practice HTML and CSS skills by creating an static site that include navigation, video, and a simple dummy form for submitting customer email. builded with planing HTML and CSS. This Project was Created originally on 2020 but I have decided to move it to its own repo here.',
    './img/projects/landing-page-original-trombones.png',
    './img/projects/landing-page-original-trombones.png',
    'Self-employed',
    'Front-End',
