const projects = [
  {
    ...
    img: './img/projects/metrics-web-app.png',
    ...
    imgDesk: './img/projects/metrics-web-app.png',
    imgPopMobile: './img/projects/metrics-web-app.png',
  ...
  },
  {
    ...
    img: './img/projects/space-travelers-hub.png',
    technologies: ['HTML', 'CSS', 'Javascript', 'React', 'Redux'],
    liveVersion:
    ...
    imgDesk: './img/projects/space-travelers-hub.png',
    imgPopMobile: './img/projects/capstone-projeect-1.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2023',
  },
  {
    ...
    img: './img/projects/Math-Magicians.png',
    ...
    imgDesk: './img/projects/Math-Magicians.png',
    imgPopMobile: './img/projects/Math-Magicians.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2023',
  },
  {
    ...
    img: './img/projects/capstone-projeect-1.png',
    ...
    imgDesk: './img/projects/capstone-projeect-1-desktop-popup.png',
    imgPopMobile: './img/projects/capstone-projeect-1.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2023',
  },
  {
    ...
    img: './img/projects/capstone-projeect-2.png',
    technologies: ['HTML', 'CSS', 'Javascript'],
    ...
    imgDesk: './img/projects/capstone-projeect-2-desktop-popup.png',
    imgPopMobile: './img/projects/capstone-projeect-2.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2023',
  },
  {
    ...
    img: './img/projects/world-wide-flags.png',
    technologies: ['HTML', 'CSS', 'JavaScript'],
    liveVersion:
    ...
    imgDesk: './img/projects/world-wide-flags.png',
    imgPopMobile: './img/projects/world-wide-flags.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2023',
  },

  {
    ...
    img: './img/projects/awesome-books.png',
    technologies: ['HTML', 'CSS', 'JavaScript'],
    ...
    imgDesk: './img/projects/awesome-books.png',
    imgPopMobile: './img/projects/awesome-books.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2023',
  },
  {
    ...
    img: './img/projects/documentation-page.png',
    ...
    imgDesk: './img/projects/documentation-page.png',
    imgPopMobile: './img/projects/documentation-page.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2020',
  },
  {
    ...
    img: './img/projects/landing-page-original-trombones.png',
    technologies: ['HTML', 'CSS'],
    ...
    imgDesk: './img/projects/landing-page-original-trombones.png',
    imgPopMobile: './img/projects/landing-page-original-trombones.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2020',
  },
  {
    ...
    img: './img/projects/tribute-page.png',
    technologies: ['HTML', 'CSS'],
    ...
    imgDesk: './img/projects/tribute-page.png',
    imgPopMobile: './img/projects/tribute-page.png',
    company: 'Self-employed',
    typeOfDev: 'Front-End',
    date: '2020',
  },
